...
SECRET_KEY = 'django-insecure-q$elvnt3i6-ffymx=bgu9hm^pgd@q8nfb!l3h0ec*-_7u723l4'
...
# Configura logging con tu diccionario personalizado
logging.config.dictConfig(CUSTOM_LOGGING_CONFIG)

# Asigna a LOGGING para que Django lo use
